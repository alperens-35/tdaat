...
export const calendarEvents: CalendarEvent[] = [
  ...
  { date: "07-05", title: "Ürümçi Katliamı'nı Anma Günü", category: "anma", description: "5 Temmuz 2009'da Doğu Türkistan'ın başkenti Ürümçi'de Çin güvenlik güçlerinin barışçıl gösteri yapan Uygur Türklerine yönelik gerçekleştirdiği katliam.", country: "Doğu Türkistan" },
  ...
  { date: "09-17", title: "Miryokefalon Zaferi", category: "tarih", description: "17 Eylül 1176'da Anadolu Selçuklu Sultanı II. Kılıç Arslan'ın Bizans İmparatoru Manuel Komnenos'a karşı kazandığı ve Anadolu'nun kesin olarak Türk yurdu olduğunu tescil eden zafer.", country: "Türkiye" },
